...
urlpatterns = [
    ...
    path('reset-password/done/', auth_views.password_reset_done,
        {'template_name': 'authentification/reset_password_done.html/'},name='password_reset_done'),
    re_path('reset-password/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', auth_views.password_reset_confirm,
        {'template_name': 'authentification/reset_password_confirm.html',
    ...
    path('reset-password/complete/', auth_views.password_reset_complete,
        {'template_name': 'authentification/reset_password_complete.html'}, name='password_reset_complete'),
